...
!(function () {
  ...
  const y = t => e => e.options.get(t),
    ...
    x = (t, e, o) => {
      ...
      for (let o = 0; o < t.length && ((0 !== e.length && !O(t[o], r)) || (s.push({ value: t[o].char, text: t[o].title, icon: t[o].char }), !a(s.length))); o++);
      return s
    },
    L = 'pattern',
    T = (t, o) => {
  ...
  t.add('emoticons', (t, e) => {
    ...
    const o = ((t, e, o) => {
      const n = h(),
        ...
        a = _(t),
        l = t => {
          return (o = '<img'), (e = t.char).length >= o.length && e.substr(0, 0 + o.length) === o ? t.char.replace(/src="([^"]+)"/, (t, e) => `src="${a}${e}"`) : t.char
          var e, o
        }
      t.on('init', () => {
        p.load(o, e).then(
    ...
    ;((t, e) => {
      ...
      (t => {
        ...
        t.ui.registry.addButton('emoticons', { tooltip: 'Emojis', icon: 'emoji', onAction: e }), t.ui.registry.addMenuItem('emoticons', { text: 'Emojis...', icon: 'emoji', onAction: e })
      })(t),
      ((t, e) => {
