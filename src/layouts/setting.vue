    ...
    <div class="setting-container">
      <t-form ref="form" :data="formData" label-align="left">
        ...
        <t-radio-group v-model="formData.brandTheme">
          <div v-for="(item, index) in COLOR_OPTIONS.slice(0, COLOR_OPTIONS.length - 1)" :key="index" class="setting-layout-drawer">
          ...
          <div class="setting-layout-drawer">
            <t-popup destroy-on-close expand-animation placement="bottom-right" trigger="click" :visible="isColoPickerDisplay" :overlay-style="{ padding: 0 }" @visible-change="onPopupVisibleChange">
              ...
              <t-radio-button :value="COLOR_OPTIONS[COLOR_OPTIONS.length - 1]" class="setting-layout-color-group dynamic-color-btn">
